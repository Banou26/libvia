// import { WebHid } from 'Remap/src/services/hid/WebHid';
// import { IKeyboard, IKeycodeCategory, IKeycodeInfo, IConnectResult } from 'Remap/src/services/hid/Hid';

import { WebHid, IKeyboard, IKeycodeCategory, IKeycodeInfo, IConnectResult } from '../dist/index';
...
const getKeeb =
  ...
  (res?: IConnectResult) =>
    webHid
      ...
      .catch(err => webHid.connect({ productId: 20043, vendorId: 35176 })
      .then(res => setTimeout(() => getKeeb(res), 1000)))
